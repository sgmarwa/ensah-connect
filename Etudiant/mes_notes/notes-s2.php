...
if(isset($_SESSION['id_etudiant'])) {
    ...
    if ($result_filiere->num_rows > 0) {
        ...
        if ($result_nomfiliere->num_rows > 0) {
            ...
            $sql = "SELECT module.id_module, module.nom_module, note_module.note_module 
                    FROM module
            ...
            $sql_moyenne = "SELECT moyenne_annuelle
                            FROM moyennes
                            WHERE id_etudiant = '$id_etudiant'
                            AND id_filiere = '$id_filiere'";
            $result_moyenne = $conn->query($sql_moyenne);
            
            if ($result_moyenne->num_rows > 0) {
            $row_moyenne = $result_moyenne->fetch_assoc();
            
            $moyenne_annuelle = $row_moyenne['moyenne_annuelle'];
        } 
        }   
    }
}     
    ...
    <main class="table" id="notes_table">
        ...
        <section class="table__body">
            <table>
                ...
                <?php if ($result_moyenne->num_rows > 0) { ?>
                <tr>
                 
                    <td colspan="5">Moyenne annuelle: <?php echo $moyenne_annuelle; ?></td>
