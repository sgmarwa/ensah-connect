...
if(isset($_SESSION['id_etudiant'])) {
    ...
    //// Récupérer l'ID de la semestre
    //UPDATE semestre    
    //SET id_semestre=2
    //WHERE id_semestre=1; 
    
    $sql_S = "SELECT id_semestre FROM semestre ";
    ...
    if ($result_S->num_rows > 0) {
        ...
        echo"valeur de id_semestre invalide ";
    }
    ...
    if ($result_filiere->num_rows > 0) {
        ...
        WHERE professeur_filiere.id_filiere = '$id_filiere' AND module.id_module LIKE CONCAT('$nomfiliere', '$id_S%')";
        ...
        <div class="container">
            ...
            <div class="back">
                <div class="inner">
                    ...
                    <a href="table_des_devoirs.php?id_module=<?php echo $row['id_module'];?> ">Voir les devoirs</a>
                </div>
            </div>
        </div>
    </div>
