...
if(isset($_SESSION['id_etudiant'])) {
    ...
    if ($result_filiere->num_rows > 0) {
        ...
        if ($result_nomfiliere->num_rows > 0) {
            ...
            // Requête SQL pour récupérer moyenne_semestrielle2
            $sql_moyenne = "SELECT moyenne_semestrielle2 , moyenne_anuelle
                            FROM moyennes
                            WHERE id_etudiant = '$id_etudiant'
                            AND id_filiere = '$id_filiere'";
            $result_moyenne = $conn->query($sql_moyenne);
            $row_moyenne = $result_moyenne->fetch_assoc();
            $moyenne_semestrielle2 = $row_moyenne['moyenne_semestrielle2'];
            $moyenne_anuelle = $row_moyenne['moyenne_anuelle'];
        ...
        <section class="table__body">
            <table>
                ...
                <tr>
                    ...
                    <td colspan="5">Moyenne Semestrielle: <?php echo $moyenne_semestrielle2; ?></td>
                
                </tr>
                <tr>
                 
                    <td colspan="5">Moyenne anuelle: <?php echo $moyenne_anuelle; ?></td>
